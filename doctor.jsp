...
<body>
	<div class="container-fluid">
		...
		<div class="row header">
			...
			<div class="col-md-10">
				<h2>
			      vydika Hospital Mangement System
					</h3>
			</div>
			...
			<div class="col-md-2 menucontent">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li role="presentation"><a href="profile.jsp">Profile</a></li>
									<li role="presentation"><a href="driver-register.jsp">ambulance drivers</a></li>
											...
											<div class="panel-body">
												<form class="form-horizontal" action="editDoct.jsp"
													...
													<div class="modal-footer">
														...
														style="background-color:#80ff00"	value="Update">
														</button>
													</div>
												</form>
											</div>
									...
									<form class="form-horizontal" action="doctorProcess.jsp"
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												<input type="submit" class="btn btn-primary" style="background-color:#80ff00"													value="Add Doctor">
											</div>
										</div>
									</form>
