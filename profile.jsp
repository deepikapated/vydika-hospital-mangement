		...
		<div class="row">
			...
			<div class="col-md-2 menucontent">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li role="presentation"><a href="driver-register.jsp">ambulance drivers</a>
				</ul>
			</div>
			<!---- Menu Ares Ends  -------->
				...
				<div class="panel panel-default contentinside">
					...
					<div class="panel-body">
						<%
							...
							while (rs.next()) {
						%>
						1	<form class="form-horizontal" action="UpdateUserDao" method="post">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" class="btn btn-primary"
										style="background-color:#80ff00" value="Update Profile">
								</div>
							</div>
						</form>
						<%
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="UpdateUserPassword" method="post">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="password" class="form-control" name="password"	value="<%=rs1.getString(6) %>">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-primary" style="background-color:#80ff00">Update
										Password</button>
								</div>
							</div>
						</form>
